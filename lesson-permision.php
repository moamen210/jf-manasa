...
<head>
    ...
    <title>manasa-lesson</title>
    <link rel="stylesheet" href="css/style-lesson-permision.css">
...
<?php include('./Connection/header.php') ?>  
    ...
    <section class="section-1">
        <div class="sec-1">
            ...
            <br>
            <h4>يجب تحويل قيمة 200 جنية إلى رقم +000000000000 ثم عمل لقطة شاشة او تصوير رقم الحوالة والتاريخ ورفع الصورة وسيتم مراجعتها من الإدمين وإذا كانت البيانات صحيحة سوف يتم قبول الطلب وبمكنك معرفة ذلك من الصفحة الشخصية</h4>
            <br>
            <form action="">
                <label for="sub-img">رفع الصورة</label>
                <input id="sub-img" type="file" accept="image/jpeg, image/png image/jpg">
            </form>
        </div>
    </section>
