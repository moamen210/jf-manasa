...
<head>
    ...
    <title>manasa-mysubscriptions</title>
    ...
    <link rel="stylesheet" href="css/style-subscriptions.css">
</head>
<body>
    ...
    <section class="section-1">
        ...
        <div class="sec-1-2">
            <input  class="search-input" type="search" id="search-input" placeholder="بحث" onkeyup="search()">
